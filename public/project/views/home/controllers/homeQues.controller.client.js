...
(function(){
    angular
        .module("CodeOverFlow")
        .controller("HomeQuesController",HomeQuesController);

    function HomeQuesController($sce, $location,$routeParams,StackEService,SearchService,ResultService,UserService) {
        var vm = this;
