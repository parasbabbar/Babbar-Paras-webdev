...
var assignmentModel = require('../../assignment/model/user/user.model.server');
    ...
    var passportproject = require('passport');
    // var session = require('express-session');
    // var cookieParser = require('cookie-parser');
    var LocalProject = require('passport-local').Strategy;
    var GoogleStrategy = require('passport-google-oauth20').Strategy;

passportproject.use('project-local', new LocalProject(localStrategy));
passportproject.serializeUser(serializeUser);
passportproject.deserializeUser(deserializeUser);

app.post("/api/project/user", createUser);
    app.post("/api/project/login",passportproject.authenticate('project-local'), login);
    ...
    app.get('/auth/project/google', passportproject.authenticate('google', { scope : ['profile', 'email'] }));
    app.get('/auth/project/google/callback',
        passportproject.authenticate('google', {
