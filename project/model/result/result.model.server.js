...
var Answer= mongoose.model("ProjectResult", ResultSchema);
    ...
    Answer.deleteAnswer = deleteAnswer;
    Answer.updateAnswer = updateAnswer;
    Answer.findAnswerByQuestionID = findAnswerByQuestionID;
    Answer.findAnswersByUser = findAnswersByUser;
    Answer.findAnswerByID = findAnswerByID;
    Answer.findAllUncheckedAnswers = findAllUncheckedAnswers;
    Answer.searchAnswerByUserID = searchAnswerByUserID;
